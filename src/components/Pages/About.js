...
const About = () => {
    ...
    <div class="md:flex flex-wrap items-center py-5 text-center">
      ...
      <div className='w-1/2'>
          <div className='border p-11 m-4 border-slate-400 rounded-md'>
            <h2 className='text-amber-500 text-6xl font-bold'>2 <sup className='text-amber-500 text-4xl -ml-5'>+</sup></h2>
            <div className='mt-3 flex items-center'>
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
            <path d="M2 11a1 1 0 011-1h2a1 1 0 011 1v5a1 1 0 01-1 1H3a1 1 0 01-1-1v-5zM8 7a1 1 0 011-1h2a1 1 0 011 1v9a1 1 0 01-1 1H9a1 1 0 01-1-1V7zM14 4a1 1 0 011-1h2a1 1 0 011 1v12a1 1 0 01-1 1h-2a1 1 0 01-1-1V4z" />
            </svg>

                <span className='text-md text-white ml-3'>YEARS OF EXPERIENCE</span>
            </div>
          </div>
      </div>
      <div className='w-1/2'>
          <div className='border p-11 m-4 border-slate-400 rounded-md'>
            <h2 className='text-amber-500 text-6xl font-bold'>52 <sup className='text-amber-500 text-4xl -ml-5'>+</sup></h2>
            <div className='mt-3 flex items-center'>
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
  ...
  <path d="M12 2.252A8.014 8.014 0 0117.748 8H12V2.252z" />
      ...
      <div className='w-1/2'>
          <div className='border p-11 m-4 border-slate-400 rounded-md'>
            <h2 className='text-amber-500 text-6xl font-bold'>49 <sup className='text-amber-500 text-4xl -ml-5'>+</sup></h2>
            <div className='mt-3 flex items-center'>
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
  <path fill-rule="evenodd" d="M9.504 1.132a1 1 0 01.992 0l1.75 1a1 1 0 11-.992 1.736L10 3.152l-1.254.716a1 1 0 11-.992-1.736l1.75-1zM5.618 4.504a1 1 0 01-.372 1.364L5.016 6l.23.132a1 1 0 11-.992 1.736L4 7.723V8a1 1 0 01-2 0V6a.996.996 0 01.52-.878l1.734-.99a1 1 0 011.364.372zm8.764 0a1 1 0 011.364-.372l1.733.99A1.002 1.002 0 0118 6v2a1 1 0 11-2 0v-.277l-.254.145a1 1 0 11-.992-1.736l.23-.132-.23-.132a1 1 0 01-.372-1.364zm-7 4a1 1 0 011.364-.372L10 8.848l1.254-.716a1 1 0 11.992 1.736L11 10.58V12a1 1 0 11-2 0v-1.42l-1.246-.712a1 1 0 01-.372-1.364zM3 11a1 1 0 011 1v1.42l1.246.712a1 1 0 11-.992 1.736l-1.75-1A1 1 0 012 14v-2a1 1 0 011-1zm14 0a1 1 0 011 1v2a1 1 0 01-.504.868l-1.75 1a1 1 0 11-.992-1.736L16 13.42V12a1 1 0 011-1zm-9.618 5.504a1 1 0 011.364-.372l.254.145V16a1 1 0 112 0v.277l.254-.145a1 1 0 11.992 1.736l-1.735.992a.995.995 0 01-1.022 0l-1.735-.992a1 1 0 01-.372-1.364z" clip-rule="evenodd" />
      ...
      <div className='w-1/2'>
          <div className='border p-11 m-4 border-slate-400 rounded-md'>
            <h2 className='text-amber-500 text-6xl font-bold'>53 <sup className='text-amber-500 text-4xl -ml-5'>+</sup></h2>
            <div className='mt-3 flex items-center'>
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
