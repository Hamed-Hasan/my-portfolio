...
const Contact = () => {
    return (
      ...
      <div className="title-section">
                <h1>GET IN <span className='text-amber-500'>TOUCH</span></h1>
                <span className='title-bg'>CONTACT</span>
            </div>

            <div  class="md:flex flex-wrap items-center py-5">
            <div class="md:w-2/5 ...">
                <h2 className='text-white text-left  text-2xl font-bold'>DON'T BE SHY !</h2>
                <p className='text-left text-slate-400 my-5'>Feel free to get in touch with me. I am always open to discussing new projects, creative ideas or opportunities to be part of your visions.</p>
